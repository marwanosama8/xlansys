            ...
            <div class="div-box-four-all">
                <div class="div-box-four box-two">
                    <div class="enwan-box-four">
                        <img src="{{ asset('assets/images/img-box-HRM-1.png') }}" alt="" />
                        <h3>{{ trans('hrm.3') }}</h3>
                    </div>
                    <p>
{{ trans('hrm.4') }}                    </p>
                ...
                <div class="div-box-four box-two">
                    <div class="enwan-box-four">
                        <img src="{{ asset('assets/images/img-box-HRM-2.png') }}" alt="" />
                        <h3>{{ trans('hrm.5') }}</h3>
                    </div>
                    <p>
                        {{ trans('hrm.6') }}
                ...
                <div class="div-box-four box-two">
                    <div class="enwan-box-four">
                        <img src="{{ asset('assets/images/img-box-HRM-3.png') }}" alt="" />
                        <h3>{{ trans('hrm.7') }}</h3>
                    </div>
                    <p>
                        {{ trans('hrm.8') }}
                ...
                <div class="div-box-four box-two">
                    <div class="enwan-box-four">
                        <img src="{{ asset('assets/images/img-box-HRM-4.png') }}" alt="" />
                        <h3>{{ trans('hrm.9') }}</h3>
                    </div>
                    <p>{{ trans('hrm.10') }}
                    </p>
