...
return [
    '1' => "Easy building and maintenance",
    '2' => "                Create an enterprise grade website with our super easy builder.
    ...
    '4' => "                Every aspect of the Flex platform is customizable, from call
    routing to each pixel of your agent's desktop UI.",
    '5' => "Instantly Omnichannel",
    '6' => "                Quickly add voice, sms, chat, WhatsApp, email, video, or your own
    channel.",
    '7' => "Analytics and WFO",
    ...
    '12' => "            JanaGate have experience in ERP generally, we have adopted Odoo as we
    ...
    '13' => "           Integrate any CRM, WFO, WFM, and custom app to manage any customer
