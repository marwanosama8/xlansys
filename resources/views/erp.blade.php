    ...
    <section class="img-ERP-all">
        <div class="container">
          <div class="img-ERP-text">
            <div class="img-ERP">
              <img src="{{asset('assets/images/img-ERP.png')}}" alt="" />
            </div>
            <div class="text-ERP">
              <h3>{{ trans('erp.1') }}</h3>
              <p>
          ...
          <div class="div-box-four-all">
            <div class="div-box-four">
              <div class="enwan-box-four">
                <img src="{{asset('assets/images/box-four-one.png')}}" alt="" />
                <h3>{{ trans('erp.3') }}</h3>
              </div>
              <p>
{{ trans('erp.4') }}              </p>
            ...
            <div class="div-box-four">
              <div class="enwan-box-four">
                <img src="{{asset('assets/images/box-four-two.png')}}" alt="" />
                <h3>{{ trans('erp.5') }}</h3>
              </div>
              <p>
     {{ trans('erp.6') }}
            ...
            <div class="div-box-four">
              <div class="enwan-box-four">
                <img src="{{asset('assets/images/box-four-three.png')}}" alt="" />
                <h3>{{ trans('erp.7') }}</h3>
              </div>
              <p>
{{ trans('erp.8') }}
            ...
            <div class="div-box-four">
              <div class="enwan-box-four">
                <img src="{{asset('assets/images/box-four-four.png')}}" alt="" />
                <h3>{{ trans('erp.9') }}</h3>
              </div>
              <p>
      {{ trans('erp.10') }}
